...
export type InkStorageLazyVecStorageVec = {
  len: { get(): Promise<number | undefined> };
  elements: { get(arg: number): Promise<LazyvecProposal | undefined> };
};
...
export type LazyvecLazyVector = {
  proposals: { len(): Promise<number>; get(index: number): Promise<LazyvecProposal | undefined> };
};
