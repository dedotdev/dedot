...
import type { GenericContractApi, WithUnpackedStorage } from 'dedot/contracts';
...
> extends GenericContractApi<Rv, ChainApi> {
  ...
  storage: {
    ...
    unpacked(): WithUnpackedStorage<LazyvecLazyVector>;
  };

  types: {
    RootStorage: LazyvecLazyVector;
    UnpackedStorage: WithUnpackedStorage<LazyvecLazyVector>;
