...
export interface ContractQuery<ChainApi extends GenericSubstrateApi, Type extends MetadataType>
  ...
  processIntegers: GenericContractQueryCall<
    ...
    ) => Promise<GenericContractCallResult<[bigint, ProcessIntegersMinMaxOutput], ContractCallResult>>,
    Type
  >;
  ...
  processBytes: GenericContractQueryCall<
    ...
    (
      ...
      options?: ContractCallOptions,
    ) => Promise<GenericContractCallResult<[FixedBytes<32>, Bytes], ContractCallResult>>,
    Type
  >;
  ...
  processStringsAndAddresses: GenericContractQueryCall<
    ...
    (
      ...
      ok: boolean[],
      options?: ContractCallOptions,
    ) => Promise<GenericContractCallResult<[bigint, boolean], ContractCallResult>>,
    Type
  >;
  ...
  processFixedPoint: GenericContractQueryCall<
    ...
    (
      ...
      options?: ContractCallOptions,
    ) => Promise<GenericContractCallResult<[UFixed<128, 18>, Fixed<128, 18>], ContractCallResult>>,
    Type
  >;
  ...
  processTuples: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<[ProcessTuplesSummaryOutput, ProcessTuplesEchoUserOutput], ContractCallResult>
    >,
    Type
  >;
