...
export interface FlipperSolContractApi<ChainApi extends GenericSubstrateApi = SubstrateApi>
  ...
  constructorTx: ConstructorTx<ChainApi, FlipperSolContractApi, 'sol'>;
