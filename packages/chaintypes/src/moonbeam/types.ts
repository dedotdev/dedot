...
import type { AccountId20, Bytes, H160, H256, Perbill, Percent, Permill, U256 } from '@delightfuldot/codecs';

export type { Bytes, AccountId20, H256, Percent, Perbill, H160, U256, Permill } from '@delightfuldot/codecs';
...
export type PalletCrowdloanRewardsCall =
  ...
  | {
      ...
      value: {
        ...
        proofs: Array<[Bytes, SpRuntimeMultiSignature]>;
      };
    }
  ...
  | {
      ...
      value: {
        rewards?: Array<[Bytes, AccountId20 | undefined, bigint]>;
      };
    };
...
export type PalletCrowdloanRewardsEvent =
  ...
  | { tag: 'NativeIdentityAssociated'; value: [Bytes, AccountId20, bigint] }
  | { tag: 'RewardsPaid'; value: [AccountId20, bigint] }
  | { tag: 'RewardAddressUpdated'; value: [AccountId20, AccountId20] }
  | { tag: 'InitializedAlreadyInitializedAccount'; value: [Bytes, AccountId20 | undefined, bigint] }
  | { tag: 'InitializedAccountWithNotEnoughContribution'; value: [Bytes, AccountId20 | undefined, bigint] };
...
export type CumulusPalletXcmEvent =
  | { tag: 'InvalidFormat'; value: Bytes }
  | { tag: 'UnsupportedVersion'; value: Bytes }
  | { tag: 'ExecutedDownward'; value: [Bytes, XcmV3TraitsOutcome] };
...
export type EthbloomBloom = Bytes;
...
export type EthereumTypesHashH64 = Bytes;
...
export type PalletCrowdloanRewardsRewardInfo = {
  ...
  contributedRelayAddresses: Array<Bytes>;
};
