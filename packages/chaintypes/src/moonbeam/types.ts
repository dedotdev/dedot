...
export type AccountId = AccountId20Like;
...
export type FrameSystemEvent =
  ...
  | { tag: 'Remarked'; value: { sender: AccountId20Like; hash: H256 } };
...
export type PalletBalancesEvent =
  | { tag: 'Endowed'; value: { account: AccountId20Like; freeBalance: bigint } }
  | { tag: 'DustLost'; value: { account: AccountId20Like; amount: bigint } }
  | { tag: 'Transfer'; value: { from: AccountId20Like; to: AccountId20Like; amount: bigint } }
  | { tag: 'BalanceSet'; value: { who: AccountId20Like; free: bigint } }
  | { tag: 'Reserved'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Unreserved'; value: { who: AccountId20Like; amount: bigint } }
  | {
  ...
  | { tag: 'Deposit'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Withdraw'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Slashed'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Minted'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Burned'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Suspended'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Restored'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Upgraded'; value: { who: AccountId20Like } }
  | { tag: 'Issued'; value: { amount: bigint } }
  | { tag: 'Rescinded'; value: { amount: bigint } }
  | { tag: 'Locked'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Unlocked'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Frozen'; value: { who: AccountId20Like; amount: bigint } }
  | { tag: 'Thawed'; value: { who: AccountId20Like; amount: bigint } };
...
export type PalletTransactionPaymentEvent = {
  ...
  value: { who: AccountId20Like; actualFee: bigint; tip: bigint };
};
...
export type PalletParachainStakingEvent =
  ...
  | {
      ...
      value: { account: AccountId20Like; amountLocked: bigint; newTotalAmtLocked: bigint };
    }
  | { tag: 'CollatorChosen'; value: { round: number; collatorAccount: AccountId20Like; totalExposedAmount: bigint } }
  | {
      tag: 'CandidateBondLessRequested';
      value: { candidate: AccountId20Like; amountToDecrease: bigint; executeRound: number };
    }
  | { tag: 'CandidateBondedMore'; value: { candidate: AccountId20Like; amount: bigint; newTotalBond: bigint } }
  | { tag: 'CandidateBondedLess'; value: { candidate: AccountId20Like; amount: bigint; newBond: bigint } }
  ...
  | {
      ...
      value: { exitAllowedRound: number; candidate: AccountId20Like; scheduledExit: number };
    }
  | { tag: 'CancelledCandidateExit'; value: { candidate: AccountId20Like } }
  | { tag: 'CancelledCandidateBondLess'; value: { candidate: AccountId20Like; amount: bigint; executeRound: number } }
  | { tag: 'CandidateLeft'; value: { exCandidate: AccountId20Like; unlockedAmount: bigint; newTotalAmtLocked: bigint } }
  | {
      tag: 'DelegationDecreaseScheduled';
      value: { delegator: AccountId20Like; candidate: AccountId20Like; amountToDecrease: bigint; executeRound: number };
    }
  | {
      tag: 'DelegationIncreased';
      value: { delegator: AccountId20Like; candidate: AccountId20Like; amount: bigint; inTop: boolean };
    }
  | {
      tag: 'DelegationDecreased';
      value: { delegator: AccountId20Like; candidate: AccountId20Like; amount: bigint; inTop: boolean };
    }
  | { tag: 'DelegatorExitScheduled'; value: { round: number; delegator: AccountId20Like; scheduledExit: number } }
  | {
      tag: 'DelegationRevocationScheduled';
      value: { round: number; delegator: AccountId20Like; candidate: AccountId20Like; scheduledExit: number };
    }
  | { tag: 'DelegatorLeft'; value: { delegator: AccountId20Like; unstakedAmount: bigint } }
  | {
      tag: 'DelegationRevoked';
      value: { delegator: AccountId20Like; candidate: AccountId20Like; unstakedAmount: bigint };
    }
  | {
  ...
  | { tag: 'Rewarded'; value: { account: AccountId20Like; rewards: bigint } }
  | { tag: 'ReservedForParachainBond'; value: { account: AccountId20Like; value: bigint } }
  | { tag: 'ParachainBondAccountSet'; value: { old: AccountId20Like; new: AccountId20Like } }
  ...
  | { tag: 'AutoCompoundSet'; value: { candidate: AccountId20Like; delegator: AccountId20Like; value: Percent } }
  | { tag: 'Compounded'; value: { candidate: AccountId20Like; delegator: AccountId20Like; amount: bigint } };
...
export type PalletMoonbeamOrbitersEvent =
  | { tag: 'OrbiterJoinCollatorPool'; value: { collator: AccountId20Like; orbiter: AccountId20Like } }
  | { tag: 'OrbiterLeaveCollatorPool'; value: { collator: AccountId20Like; orbiter: AccountId20Like } }
  | { tag: 'OrbiterRewarded'; value: { account: AccountId20Like; rewards: bigint } }
  | {
      tag: 'OrbiterRotation';
      value: {
        collator: AccountId20Like;
  ...
  | { tag: 'OrbiterRegistered'; value: { account: AccountId20Like; deposit: bigint } }
...
export type PalletProxyEvent =
  ...
  | { tag: 'Announced'; value: { real: AccountId20Like; proxy: AccountId20Like; callHash: H256 } }
  | {
      tag: 'ProxyAdded';
      value: {
        delegator: AccountId20Like;
...
export type PalletIdentityEvent =
  ...
  | { tag: 'IdentityCleared'; value: { who: AccountId20Like; deposit: bigint } }
  | { tag: 'IdentityKilled'; value: { who: AccountId20Like; deposit: bigint } }
  | { tag: 'JudgementRequested'; value: { who: AccountId20Like; registrarIndex: number } }
  | { tag: 'JudgementUnrequested'; value: { who: AccountId20Like; registrarIndex: number } }
  | { tag: 'JudgementGiven'; value: { target: AccountId20Like; registrarIndex: number } }
  | { tag: 'RegistrarAdded'; value: { registrarIndex: number } }
  | { tag: 'SubIdentityAdded'; value: { sub: AccountId20Like; main: AccountId20Like; deposit: bigint } }
  | { tag: 'SubIdentityRemoved'; value: { sub: AccountId20Like; main: AccountId20Like; deposit: bigint } }
  | { tag: 'SubIdentityRevoked'; value: { sub: AccountId20Like; main: AccountId20Like; deposit: bigint } };
...
export type PalletMultisigEvent =
  | { tag: 'NewMultisig'; value: { approving: AccountId20Like; multisig: AccountId20Like; callHash: FixedBytes<32> } }
  | {
...
export type PalletDemocracyEvent =
  ...
  | { tag: 'Delegated'; value: { who: AccountId20Like; target: AccountId20Like } }
  | { tag: 'Undelegated'; value: { account: AccountId20Like } }
  | { tag: 'Vetoed'; value: { who: AccountId20Like; proposalHash: H256; until: number } }
  | { tag: 'Blacklisted'; value: { proposalHash: H256 } }
  | { tag: 'Voted'; value: { voter: AccountId20Like; refIndex: number; vote: PalletDemocracyVoteAccountVote } }
  | { tag: 'Seconded'; value: { seconder: AccountId20Like; propIndex: number } }
...
export type PalletCollectiveEvent =
  | {
      tag: 'Proposed';
      value: { account: AccountId20Like; proposalIndex: number; proposalHash: H256; threshold: number };
    }
  | { tag: 'Voted'; value: { account: AccountId20Like; proposalHash: H256; voted: boolean; yes: number; no: number } }
...
export type PalletTreasuryEvent =
  ...
  | { tag: 'Awarded'; value: { proposalIndex: number; award: bigint; account: AccountId20Like } }
  ...
  | { tag: 'SpendApproved'; value: { proposalIndex: number; amount: bigint; beneficiary: AccountId20Like } }
...
export type PalletAssetsEvent =
  | { tag: 'Created'; value: { assetId: bigint; creator: AccountId20Like; owner: AccountId20Like } }
  | { tag: 'Issued'; value: { assetId: bigint; owner: AccountId20Like; amount: bigint } }
  | { tag: 'Transferred'; value: { assetId: bigint; from: AccountId20Like; to: AccountId20Like; amount: bigint } }
  | { tag: 'Burned'; value: { assetId: bigint; owner: AccountId20Like; balance: bigint } }
  | {
      tag: 'TeamChanged';
      value: { assetId: bigint; issuer: AccountId20Like; admin: AccountId20Like; freezer: AccountId20Like };
    }
  | { tag: 'OwnerChanged'; value: { assetId: bigint; owner: AccountId20Like } }
  | { tag: 'Frozen'; value: { assetId: bigint; who: AccountId20Like } }
  | { tag: 'Thawed'; value: { assetId: bigint; who: AccountId20Like } }
  ...
  | { tag: 'ForceCreated'; value: { assetId: bigint; owner: AccountId20Like } }
  ...
  | {
      ...
      value: { assetId: bigint; source: AccountId20Like; delegate: AccountId20Like; amount: bigint };
    }
  | { tag: 'ApprovalCancelled'; value: { assetId: bigint; owner: AccountId20Like; delegate: AccountId20Like } }
  | {
  ...
  | { tag: 'Touched'; value: { assetId: bigint; who: AccountId20Like; depositor: AccountId20Like } }
  | { tag: 'Blocked'; value: { assetId: bigint; who: AccountId20Like } };
...
export type PalletAssetManagerEvent =
  ...
  | { tag: 'LocalAssetRegistered'; value: { assetId: bigint; creator: AccountId20Like; owner: AccountId20Like } }
...
export type PalletXcmTransactorEvent =
  | {
      ...
      value: { accountId: AccountId20Like; dest: XcmV3MultilocationMultiLocation; call: Bytes; index: number };
    }
  | {
      tag: 'TransactedSovereign';
      value: { feePayer: AccountId20Like; dest: XcmV3MultilocationMultiLocation; call: Bytes };
    }
  | {
      tag: 'TransactedSigned';
      value: { feePayer: AccountId20Like; dest: XcmV3MultilocationMultiLocation; call: Bytes };
    }
  | { tag: 'RegisteredDerivative'; value: { accountId: AccountId20Like; index: number } }
...
export type PalletParachainStakingParachainBondConfig = { account: AccountId20Like; percent: Percent };
...
export type PalletParachainStakingBond = { owner: AccountId20Like; amount: bigint };
...
export type PalletParachainStakingAutoCompoundAutoCompoundConfig = { delegator: AccountId20Like; value: Percent };
...
export type PalletMoonbeamOrbitersCurrentOrbiter = { accountId: AccountId20Like; removed: boolean };
...
export type PalletProxyAnnouncement = { real: AccountId20Like; callHash: H256; height: number };
...
export type PalletIdentityRegistrarInfo = { account: AccountId20Like; fee: bigint; fields: PalletIdentityBitFlags };
...
export type PalletPreimageRequestStatus =
  | { tag: 'Unrequested'; value: { deposit: [AccountId20Like, bigint]; len: number } }
  | {
      tag: 'Requested';
      value: { deposit?: [AccountId20Like, bigint] | undefined; count: number; len?: number | undefined };
    };
...
export type PalletReferendaDeposit = { who: AccountId20Like; amount: bigint };
...
export type PalletAssetManagerAssetInfo = { creator: AccountId20Like; deposit: bigint };
