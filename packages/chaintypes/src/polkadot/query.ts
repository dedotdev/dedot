...
export interface ChainStorage extends GenericChainStorage {
  ...
  session: {
     ...
     **/
    nextKeys(arg: AccountId32Like): Promise<PolkadotRuntimeSessionKeys>;
  ...
  democracy: {
     ...
     **/
    depositOf(arg: number): Promise<[Array<AccountId32Like>, bigint]>;
     ...
     **/
    blacklist(arg: H256): Promise<[number, Array<AccountId32Like>]>;
  ...
  council: {
     ...
     **/
    proposalOf(arg: H256): Promise<PolkadotRuntimeRuntimeCall>;
  ...
  tips: {
     ...
     **/
    tips(arg: H256): Promise<PalletTipsOpenTip>;

    /**
     * Simple preimage lookup from the reason's hash to the original data. Again, has an
     * insecure enumerable hash since the key is guaranteed to be the result of a secure hash.
     **/
    reasons(arg: H256): Promise<Bytes>;
  };
