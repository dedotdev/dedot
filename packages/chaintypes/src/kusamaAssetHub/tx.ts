...
export type ChainSubmittableExtrinsic<T extends IRuntimeTxCall = AssetHubKusamaRuntimeRuntimeCallLike> = Extrinsic<
  MultiAddressLike,
  T,
  SpRuntimeMultiSignature,
  any[]
...
export interface ChainTx extends GenericChainTx<TxCall> {
  ...
  session: {
    ...
    setKeys: GenericTxCall<
      (
        keys: AssetHubKusamaRuntimeSessionKeys,
        proof: BytesLike,
      ) => ChainSubmittableExtrinsic<{
        pallet: 'Session';
        palletCall: {
          name: 'SetKeys';
          params: { keys: AssetHubKusamaRuntimeSessionKeys; proof: BytesLike };
        };
      }>
    >;
  ...
  /**
   * Pallet `ToPolkadotXcmRouter`'s transaction calls
   **/
  toPolkadotXcmRouter: {
    /**
  ...
  utility: {
     ...
     **/
    batch: GenericTxCall<
      (calls: Array<AssetHubKusamaRuntimeRuntimeCallLike>) => ChainSubmittableExtrinsic<{
        pallet: 'Utility';
        palletCall: {
          name: 'Batch';
          params: { calls: Array<AssetHubKusamaRuntimeRuntimeCallLike> };
        };
      }>
    >;
    ...
    asDerivative: GenericTxCall<
      (
        ...
        palletCall: {
          name: 'AsDerivative';
          params: { index: number; call: AssetHubKusamaRuntimeRuntimeCallLike };
        };
      }>
    >;
    ...
    withWeight: GenericTxCall<
      (
        ...
        palletCall: {
          name: 'WithWeight';
          params: { call: AssetHubKusamaRuntimeRuntimeCallLike; weight: SpWeightsWeightV2Weight };
        };
      }>
    >;
  ...
  proxy: {
    ...
    createPure: GenericTxCall<
      (
        ...
        palletCall: {
          name: 'CreatePure';
          params: { proxyType: AssetHubKusamaRuntimeProxyType; delay: number; index: number };
        };
      }>
    >;
