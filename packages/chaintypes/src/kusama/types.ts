...
export type FrameSystemEventRecord = {
  ...
  event: KusamaRuntimeRuntimeEvent;
  topics: Array<H256>;
};
...
export type PalletUtilityCall =
  ...
  | {
      tag: 'dispatch_as';
      value: {
        asOrigin: KusamaRuntimeOriginCaller;
        call: KusamaRuntimeRuntimeCall;
      };
    }
...
export type PalletSocietyEvent =
  ...
  | {
      tag: 'Inducted';
      value: {
        primary: AccountId32Like;
        candidates: Array<AccountId32Like>;
      };
    }
  | {
      tag: 'SuspendedMemberJudgement';
      value: {
        who: AccountId32Like;
        judged: boolean;
      };
...
export type PalletRecoveryEvent =
  ...
  | {
      tag: 'RecoveryInitiated';
      value: {
        lostAccount: AccountId32Like;
        rescuerAccount: AccountId32Like;
      };
    }
  | {
      tag: 'RecoveryVouched';
...
export type PalletBalancesIdAmount = {
  id: KusamaRuntimeRuntimeHoldReason;
  amount: bigint;
};
...
export type PalletBalancesIdAmount002 = {
  id: [];
  amount: bigint;
};
