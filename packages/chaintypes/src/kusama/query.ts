...
export interface ChainStorage extends GenericChainStorage {
  ...
  beefy: {
    ...
    authorities(callback: Callback<Array<SpConsensusBeefyEcdsaCryptoPublic>>): Promise<Unsub>;

    /**
     * The current validator set id
     **/
    validatorSetId(): Promise<bigint>;
    validatorSetId(callback: Callback<bigint>): Promise<Unsub>;

    /**
     * Authorities set scheduled to be used with the next session
     **/
    nextAuthorities(): Promise<Array<SpConsensusBeefyEcdsaCryptoPublic>>;
    nextAuthorities(callback: Callback<Array<SpConsensusBeefyEcdsaCryptoPublic>>): Promise<Unsub>;
    ...
    genesisBlock(callback: Callback<number | undefined>): Promise<Unsub>;
  };
  mmr: {
    /**
  ...
  beefyMmrLeaf: {
    ...
    beefyAuthorities(callback: Callback<SpConsensusBeefyMmrBeefyAuthoritySet>): Promise<Unsub>;
    ...
    beefyNextAuthorities(callback: Callback<SpConsensusBeefyMmrBeefyAuthoritySet>): Promise<Unsub>;
  };
  session: {
    /**
    ...
    queuedKeys(callback: Callback<Array<[AccountId32, StagingKusamaRuntimeSessionKeys]>>): Promise<Unsub>;
    ...
    nextKeys(arg: AccountId32Like, callback: Callback<StagingKusamaRuntimeSessionKeys | undefined>): Promise<Unsub>;
