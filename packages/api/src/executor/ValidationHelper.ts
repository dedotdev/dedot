...
/**
 * Helper class for validating API call parameters and generating detailed error messages
 */
export class ValidationHelper {
  /**
   * Build a comprehensive API compatibility error with detailed information
   */
  static buildCompatibilityError(
    originalError: Error,
    params: ParamSpec[],
    args: any[],
  ...
  /**
   * Find codec for a parameter
   */
  private static findCodec(param: ParamSpec, registry: TypeRegistry): AnyShape | undefined {
