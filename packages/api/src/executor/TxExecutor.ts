...
import type { GenericTxCall, IRuntimeTxCall, RpcLegacy, VersionedGenericSubstrateApi } from '@dedot/types';
import { assert, stringCamelCase, stringPascalCase, UnknownApiError } from '@dedot/utils';
import { SubmittableExtrinsicLegacy } from '../extrinsic/index.js';
...
> extends Executor<ChainApi> {
  ...
  protected createExtrinsic(call: IRuntimeTxCall): any {
    return new SubmittableExtrinsicLegacy(this.api as ISubstrateClient<SubstrateApi[RpcLegacy]>, call);
  }
}
