...
import { StorageEntryLatest, ViewFunctionDefLatest } from './Metadata.js';
...
export interface PalletViewFunctionMetadataLatest extends ViewFunctionDefLatest, PalletInfo {}
